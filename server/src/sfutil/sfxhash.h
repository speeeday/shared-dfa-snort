...
SFXHASH       * sj_sfxhash_new( unsigned nrows, int keysize, int datasize, unsigned long memcap,
                             int anr_flag,
                             SFXHASH_FREE_FCN anrfunc,
                             SFXHASH_FREE_FCN usrfunc,
                             int recycle_flag );
...
int             sj_sfxhash_make_empty(SFXHASH *);

int             sfxhash_add ( SFXHASH * h, void * key, void * data );
int             sj_sfxhash_add ( SFXHASH * h, void * key, void * data );
...
int             sj_sfxhash_remove( SFXHASH * h, void * key );
...
int             sj_sfxhash_free_node(SFXHASH *t, SFXHASH_NODE *node);
/* sfxhash_free_anr_lru frees a node from the free list or the LRU node */
