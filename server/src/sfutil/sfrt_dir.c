                                       ...
                                       uint32_t prefill, uint32_t bit_length)
{
    ...
    sub = (dir_sub_table_t*)sj_malloc(sizeof(dir_sub_table_t));
    ...
    sub->entries = (word*)sj_malloc(sizeof(word) * sub->num_entries);
    ...
    sub->lengths = (uint8_t*)sj_malloc(sub->num_entries);
...
dir_table_t *sfrt_dir_new(uint32_t mem_cap, int count,...)
{
    ...
    dir_table_t* table = (dir_table_t*)sj_malloc(sizeof(dir_table_t));
    ...
    table->dimensions = (int*)sj_malloc(sizeof(int)*count);
