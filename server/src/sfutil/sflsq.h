...
void      sj_sflist_init ( SF_LIST * s);
int       sj_sflist_add_tail ( SF_LIST* s, NODE_DATA ndata );
int       sj_sflist_add_head ( SF_LIST* s, NODE_DATA ndata );
int       sj_sflist_add_before ( SF_LIST* s, SF_LNODE * lnode, NODE_DATA ndata );
int       sj_sflist_add_after ( SF_LIST* s, SF_LNODE * lnode, NODE_DATA ndata );
...
void      sj_sflist_free_all( SF_LIST * s, void (*free)(void*) );
void sj_sflist_static_free_all(SF_LIST *, void(*nfree)(void *));
void sj_sflist_static_free(SF_LIST *);
...
SF_STACK *sj_sfstack_new ( void );
int       sj_sfstack_add( SF_STACK* s, NODE_DATA ndata );
NODE_DATA sj_sfstack_remove ( SF_STACK * s);
...
void      sj_sfstack_free_all( SF_STACK* s, void (*free)(void*) );
void sj_sfstack_static_free_all(SF_STACK *,void (*nfree)(void *));
void sj_sfstack_static_free(SF_STACK *);
...
void      sj_sfqueue_free_all( SF_QUEUE* s, void (*free)(void*) );
void sj_sfqueue_static_free_all(SF_QUEUE *,void (*nfree)(void *));
void sj_sfqueue_static_free(SF_QUEUE *);
