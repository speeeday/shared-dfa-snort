                        ...
                        RuleOptOtnHandler otn_handler)
{
    ...
    node = (RuleOptConfigFuncNode *)calloc(1,sizeof(RuleOptConfigFuncNode));
    ...
    if (override_init_func != NULL)
    {
        RuleOptOverrideInitFuncNode *node_override =
            (RuleOptOverrideInitFuncNode *)calloc(1,sizeof(RuleOptOverrideInitFuncNode));
...
{
    RuleOptByteOrderFuncNode *node = (RuleOptByteOrderFuncNode *)calloc(1,sizeof(RuleOptByteOrderFuncNode));
...
{
    OptFpList *ofp = (OptFpList *)calloc(1,sizeof(OptFpList));
...
{
    RspFpList *rsp = (RspFpList *)calloc(1,sizeof(RspFpList));
                                            ...
                                            uint32_t proto_mask)
{
    ...
    node = (DetectionEvalFuncNode *)calloc(1,sizeof(DetectionEvalFuncNode));
...
#endif
{
    PreprocConfigFuncNode *node =
        (PreprocConfigFuncNode *)calloc(1,sizeof(PreprocConfigFuncNode));
...
void RegisterPreprocStats(const char *keyword, PreprocStatsFunc pp_stats_func)
{
    ...
    node = (PreprocStatsFuncNode *)calloc(1,sizeof(PreprocStatsFuncNode));
                                           ...
                                           uint32_t preproc_id, uint32_t proto_mask)
{
    ...
    node = (PreprocEvalFuncNode *)calloc(1,sizeof(PreprocEvalFuncNode));
    ...
    uint32_t preproc_id)
{
    ...
    node = (PreprocMetaEvalFuncNode *)calloc(1,sizeof(PreprocMetaEvalFuncNode));
                                    ...
                                    void *data)
{
    ...
    node = (PreprocPostConfigFuncNode *)calloc(1,sizeof(PreprocPostConfigFuncNode));
...
void AddFuncToConfigCheckList(SnortConfig *sc, PreprocCheckConfigFunc pp_chk_config_func)
{
    ...
    node = (PreprocCheckConfigFuncNode *)calloc(1,sizeof(PreprocCheckConfigFuncNode));
                                       ...
                                       uint16_t priority, uint32_t preproc_id)
{
    ...
    node = (PreprocSignalFuncNode *)calloc(1,sizeof(PreprocSignalFuncNode));
        ...
        uint16_t priority, uint32_t preproc_id, uint32_t period )
{
    ...
    node = (PeriodicCheckFuncNode *)calloc(1,sizeof(PeriodicCheckFuncNode));
...
{
    OutputConfigFuncNode *node = (OutputConfigFuncNode *)calloc(1,sizeof(OutputConfigFuncNode));
...
void AppendOutputFuncList(OutputFunc o_func, void *arg, OutputFuncNode **list)
{
    ...
    node = (OutputFuncNode *)calloc(1,sizeof(OutputFuncNode));
...
static inline void _AddFuncToPostConfigList(PostConfigFunc pl_post_func, void *arg, PostConfigFuncNode **list)
{
    ...
    node = (PostConfigFuncNode *)calloc(1,sizeof(PostConfigFuncNode));
...
void AddFuncToSignalList(PluginSignalFunc pl_sig_func, void *arg, PluginSignalFuncNode **list)
{
    ...
    node = (PluginSignalFuncNode *)calloc(1,sizeof(PluginSignalFuncNode));
...
void AddFuncToRuleOptParseCleanupList(RuleOptParseCleanupFunc ro_parse_clean_func)
{
    RuleOptParseCleanupNode *node =
        (RuleOptParseCleanupNode *)calloc(1,sizeof(RuleOptParseCleanupNode));
