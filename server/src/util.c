...
int DisplayBanner(void)
{
    ...
    LogMessage("           Copyright (C) 2014-2018 Cisco and/or its affiliates. All rights reserved.\n");
...
char *sj_SnortStrndup(const char *src, size_t dst_size)
{
	char *ret = sj_malloc(dst_size + 1);
    int ret_val;
...
char * sj_SnortStrdup(const char *str)
{
    char *copy = NULL;
