...
int16_t AddProtocolReference(const char *protocol)
{
    ...
    sj_sfghash_add(proto_reference_table, reference->name, reference);
#if defined(FEAT_OPEN_APPID)
...
void InitializeProtocolReferenceTable(void)
{
    ...
    proto_reference_table = sj_sfghash_new(65, 0, 1, sj_free);
...
{
    sj_sfghash_delete(proto_reference_table);
